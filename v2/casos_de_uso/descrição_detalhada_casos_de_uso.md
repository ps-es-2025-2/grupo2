...
## 10. UC10 – Gerar Relatórios

*Ator:* Administrador
*Objetivo:* Consultar relatórios de vendas, estoque e desempenho do evento.
*Pré-condições:* Dados suficientes registrados.

*Fluxo Principal:*
1. Administrador acessa módulo de relatórios.
2. Escolhe o tipo (vendas, ranking de produtos, pico de horários, projeção de estoque).
3. Sistema processa e exibe relatório.

*Pós-condições:* Relatório exibido para análise.